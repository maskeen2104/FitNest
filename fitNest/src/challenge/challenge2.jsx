...
const PullUps = () => {
  ...
  const handleSubmit = () => {
    navigate('/anotherPageChallenge2');
  };
  ...
  return (
    <div className="container">
      <section className="challenge-info">
        <h1 className="title" style = {{ fontSize: "30px", marginLeft: "-20px"}}>Pull up challenge </h1>
        ...
        {dataAdded.length > 0 && (
          <p className="description" style = {{ fontSize: "20px"}}>
            Do {pullUps[0].challenges[0].pushUpsToDo} pull-ups every day for 30 days. Track your progress and see
